...
import StyledPracticeExtensionsTextFeildWrapper from './styles';
...
function PracticeExtensionsTextFeild(props: PracticeExtensionsTextFeildProps) {
  ...
  if (displayMode === 'LABELS_LEFT' || displayMode === 'DISPLAY_ONLY') {
    ...
    return displayMode === 'DISPLAY_ONLY' ? (
      <StyledPracticeExtensionsTextFeildWrapper> {displayComp} </StyledPracticeExtensionsTextFeildWrapper>
    ) : (
      <StyledPracticeExtensionsTextFeildWrapper>
        <FieldValueList
...
export default withConfiguration(PracticeExtensionsTextFeild);
